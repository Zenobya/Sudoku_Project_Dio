...
public class FinishGameButton extends JButton {
    ...
    private static final Color NEON      = new Color(255, 60, 120);
    private static final Color NEON_DIM  = new Color(180, 40, 85);
    private static final Color BG_NORMAL = new Color(22, 0, 10);
    private static final Color BG_HOVER  = new Color(40, 0, 20);
    private static final Color GLOW      = new Color(255, 60, 120, 55);
