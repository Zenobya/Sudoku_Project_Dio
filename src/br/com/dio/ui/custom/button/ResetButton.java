...
public class ResetButton extends JButton {
    ...
    private static final Color NEON      = new Color(80, 160, 255);
    private static final Color NEON_DIM  = new Color(55, 110, 180);
    private static final Color BG_NORMAL = new Color(0, 8, 22);
    private static final Color BG_HOVER  = new Color(0, 16, 40);
    private static final Color GLOW      = new Color(80, 160, 255, 55);
